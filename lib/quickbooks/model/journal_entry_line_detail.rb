module Quickbooks
  module Model
    class JournalEntryLineDetail < BaseModel
      ...
      xml_accessor :journal_code_ref, :from => 'JournalCodeRef', :as => BaseReference
      ...
      reference_setters :account_ref, :class_ref, :department_ref, :tax_code_ref, :journal_code_ref
